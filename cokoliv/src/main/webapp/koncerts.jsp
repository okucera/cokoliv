			...
			<tr>
	  		...
	  		<tr>
	  			<td class="main">
					...
					<CokolivTags:BasicPanel title="Koncíky" activeFormId="<%= formId %>">
						<CokolivTags:WizzardComponent activeFormId="<%= formId %>">
							<CokolivTags:ImageWizzardItem flowData="<%= data %>" repository="<%= UploadRepositories.CONCERTS_IMAGE_UPLOAD_REPOSITORY %>"/>
							<CokolivTags:ConcertTextWizzardItem flowData="<%= data %>"/>
						</CokolivTags:WizzardComponent>
 						<CokolivTags:ConcertsList/>
